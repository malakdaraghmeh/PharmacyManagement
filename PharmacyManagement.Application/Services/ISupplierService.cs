...
public interface ISupplierService
{
    ...
    Task<PagedResponse<SupplierResponseDto>> GetAllAsync(string userId, int page, int pageSize, string? name, string? contactPerson, string? phone, string? email, bool? isActive);
